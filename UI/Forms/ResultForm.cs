...
// 左表右图：底部区域拆成两列，左侧为销售明细列表，右侧预留洞察面板
...
// 销售明细列表宽度固定在窗体宽度的约 35%~40%，避免随着窗口放大无限拉伸
var listWidth = Math.Max(640, (int)(ClientSize.Width * 0.38));
...
// 右侧：洞察面板占位（Top / Middle / Bottom 三层）
